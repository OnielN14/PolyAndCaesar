...
public class tes extends javax.swing.JFrame {
    ...
    public tes(String jmlkey) {
        initComponents();
        
        int a = 0;
        JTextField field[] = new JTextField[Integer.parseInt(jmlkey)];
        for (int i = 0; i < field.length; i++) {
            field[i] = new JTextField(Integer.parseInt(jmlkey));
            add(field[i]);
//            field[i].setText("");
            a+=30;
            field[i].setBounds(0, a, 120, 30);
        }
    }
     ...
     */
//    public static void main(String args[], int JLabel) {
//             
//      
